...
# Amiculum Digital Boilerplate


Forked and adapted from: https://travis-ci.com/tr1s/tris-webpack-boilerplate
...
1. `git clone https://github.com/LTorson/Amiculum-Digital-boilerplate your-project-name`
...
plugins: [
  new HtmlWebpackPlugin({
    title: 'amiculum-digital-boilerplate',
    filename: 'index.html',
    template: './src/index.html',
    inject: 'head'
  }),
  new HtmlWebpackPlugin({
    title: 'amiculum-digital-404-page',
    filename: '404.html',
